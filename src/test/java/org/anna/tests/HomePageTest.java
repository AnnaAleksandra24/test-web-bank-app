...
//        Thread.sleep(1000);
    ...
    public void testPageBodyRenders (){
        // Home Page Title H1 exist and contains correct text
        ...
        // Home Page SubTitle p exist and contains correct text
        WebElement subTitle = driver.findElement(ByTestId.testId("home-page-subtitle"));
        assertTrue(subTitle.isDisplayed());
        assertEquals("Something short and leading about the Web Bank application", subTitle.getText());
        assertEquals("p", subTitle.getTagName());

        // Home Page contains primary CTA button and it has a correct text
        ...
        // Home Page contains secondary CTA button and it has a correct text
